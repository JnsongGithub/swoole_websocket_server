...
return [
    // 扩展自身配置
    'host'                  => '192.168.100.103', // 监听地址
    'port'                  => 9508, // 监听端口
    'mode'                  => '', // 运行模式 默认为SWOOLE_PROCESS
    'sock_type'             => 'SWOOLE_SOCK_TCP', // sock type 默认为SWOOLE_SOCK_TCP
    'server_type'           => 'websocket', // 服务类型 支持 http websocket
    'app_path'              => '/home/devwww/boss_api/application', // 应用地址 如果开启了 'daemonize'=>true 必须设置（使用绝对路径）
    'file_monitor'          => false, // 是否开启PHP文件更改监控（调试模式下自动开启）
    'file_monitor_interval' => 2, // 文件变化监控检测时间间隔（秒）
    'file_monitor_path'     => [], // 文件监控目录 默认监控application和config目录

    'swoole_class' => 'app\boss\controller\Swoole', // 自定义服务类名称
    //'app_path'	=> '/home/devwww/boss_api/application/',
    'ssl' => true,
    'ssl_cert_file' => '/home/ssl/budingvip.com.crt123',
    'ssl_key_file' => '/home/ssl/budingvip.com.key123',
