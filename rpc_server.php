...
Swoole\Network\Server::start(function ()
{
     ...
     * 默认使用 apps/classes
     */
    $AppSvr->addNameSpace('app', __DIR__ . '/application/im/controller');
     ...
     * 设置用户名密码
     */
    $AppSvr->addAllowUser('xiangqin', 'xiangqin123');

//    Swoole\Error::$echo_html = false;
    $server = Swoole\Network\Server::autoCreate('0.0.0.0', 16666); //开启的端口号
