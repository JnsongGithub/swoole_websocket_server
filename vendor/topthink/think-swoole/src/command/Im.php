 ...
 */
class Im extends Swoole
{
    public function configure()
    {
        $this->setName('swoole:im')
    ...
    protected function reload()
    {
        ...
        $killResu = Process::kill($pid, SIGUSR1);
        SLog::info('reloadKill:'.$killResu);
    ...
    protected function stop()
    {
        ...
        $killResu = Process::kill($pid, SIGTERM);
        SLog::info('stopKill:'.$killResu);
        $this->removePid();
