...
class RPCServer extends Base implements Swoole\IFace\Protocol
{
    ...
    function onReceive($serv, $fd, $reactor_id, $data)
    {
        ...
        /*
         * {"call":"app\\im\\controller\\RClient::index","params":["hello0_1"],"env":{"app":"test","appKey":"test1234","user":"xiangqin","password":"xiangqin123"}}
         * */
        if ($request === false)
        {
        ...
        else
        {
            ...
            echo json_encode($response)."-----REQUEST\n";
            //发送响应
...
//                return \swoole_serialize::unpack($data); //原代码
    ...
    protected function call($request, $header)
    {
        ...
        echo json_encode($request)."-----校验函数\n";
        SLog::INFO('服务端测试测试SLOG');
        //函数不存在
